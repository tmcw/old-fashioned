...
export const collinsGlass = new Glass(
  "Collins glass",
  "M13 4H7v12.5c.5.25 1.5.5 3 .5s2.712-.24 3-.5V4zm-6 6.554l6-.054",
);
export const highballGlass = new Glass(
  "Highball glass",
  "M13 4H6v11c.512.239 1.792.5 3.5.5s3.158-.261 3.5-.5V4zm-7 6h7",
);
export const oldFashionedGlass = new Glass(
  "Old fashioned glass",
  "M14 5H6v10c.582.209 2.06.5 4 .5s3.612-.291 4-.5V5zm-8 5h8",
);
export const champagneCoupe = new Glass(
  "Champagne coupe",
  "M9.25 16.5v-8L8 7 6 6 4.5 4.5V3h11v1.5l-1.5 2-2 .5-1.25 1.5v8h1.582v.5H7.196v-.5H9.25z",
);
export const champagneFlute = new Glass(
  "Champagne flute",
  "M9.25 17v-5.616L8 7.5 8.5 3h3l.5 4.5-1.25 3.884V17H12v.63H8V17h1.25zM8 4.856h3.616",
);
export const cocktailGlass = new Glass(
  "Cocktail glass",
  "M9 9.5L5.5 4h9l-3.501 5.5v4.75H13v1.25H7v-1.25h2.056L9 9.5zm-2.5-4h7",
);
export const hurricane = new Glass(
  "Hurricane",
